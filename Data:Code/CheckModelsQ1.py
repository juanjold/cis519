...
#Make Predictions
TrainPredLin = modelLin.predict(Xtrain)
TestPredLin = modelLin.predict(Xtest)
...
print ("Residual sum of squares: %.2f" %
        np.mean((modelLin.predict(Xtest) - ytest) ** 2))
# Explained variance score: 1 is perfect prediction
print ('Variance score: %.2f' % modelLin.score(Xtest, ytest))
