...
%Update this to relate to how we broke down classes!!
\begin{flushleft}
\begin{table}[h]
\caption{Interpretations of the MMSE Score, ranging from full normal cognition to sever impairment -- which is closely correlated with the presence of dementia.}
\label{sample-table}
\vskip 0.15in
\begin{center}
\begin{small}
